            ...
            >
              {filteredExperiences.map((exp, index) => {
                ...
                return (
                  ...
                  >
                    {/* Timeline Dot */}
                    <div className="relative z-10 w-12 h-12 md:w-16 md:h-16 shrink-0 bg-card border-2 border-primary rounded-full flex items-center justify-center">
                      <Icon className="w-5 h-5 md:w-6 md:h-6 text-primary" />
                    </div>

                    {/* Content Card */}
                    <div className="flex-1 bg-card rounded-xl p-6 border border-border hover:border-primary/50 transition-colors group">
